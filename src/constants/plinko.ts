export const CANVA_WIDTH = 800
export const CANVA_HEIGHT = 800
export const ballColor = 'blue'
export const friction = { x: 0.4, y: 0.8 }
export const possibleRows = [8, 9, 10, 11, 12, 13, 14, 15, 16] as const
export type MaxRow = (typeof possibleRows)[number]
export const riskLevels = ['low', 'medium', 'high'] as const
export type Risk = (typeof riskLevels)[number]
export const widthOfTilesContainer: { [key: number]: string } = {
  8: '88.5%',
  9: '89%',
  10: '89.5%',
  11: '90.5%',
...
export type RowRewards = typeof ROW_REWARDS
